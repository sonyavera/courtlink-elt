...
INSERT INTO :schema.organizations (
    ...
    (
        ...
        NULL,
        'Pickleball Plus',
        '{"timezone": "America/New_York", "weekday_peak": null, "weekend_peak": null, "weekday_off_peak": [{"end": "01:00", "start": "23:00"}, {"end": "16:00", "start": "14:00"}], "weekend_off_peak": [{"end": "08:00", "start": "06:00"}]}'::jsonb,
        'West Hempstead',
        NULL,
        NULL,
