"""create_facility_event_categories_table

Revision ID: 0a51c0d82319
Revises: 424b0dd15504
Create Date: 2025-11-23 10:25:29.208212
...
revision: str = '0a51c0d82319'
down_revision: Union[str, None] = '424b0dd15504'
...
def upgrade() -> None:
    ...
    # Create facility_event_categories table if it doesn't exist
